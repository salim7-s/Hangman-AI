...
| Document | Purpose |
| --- | --- |
| [executive_summary.md](./executive_summary.md) | High-level summary of architecture, algorithms, and key highlights |
| [project_overview.md](./project_overview.md) | Compact one-page technical brief |
...
| [performance_optimization.md](./performance_optimization.md) | Latency benchmarks, memory optimizations, and caching strategies |
| [presentation/](./presentation/) | PowerPoint slide decks (`.pptx`) and presentation visual assets |
| [presentation_notes.md](./presentation_notes.md) | Demo and interview presentation notes |
...
| [ai_algorithm/frequency_model.md](./ai_algorithm/frequency_model.md) | Positional frequency model |
| [ai_algorithm/heuristic_model.md](./ai_algorithm/heuristic_model.md) | Medium difficulty candidate heuristic strategy |
| [ai_algorithm/shannon_entropy.md](./ai_algorithm/shannon_entropy.md) | Hard difficulty N-gram and entropy strategy |
